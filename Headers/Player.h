...
public:
    static Player Warrior(const std::string& pname = "Player") {return Player(pname, 5, 200, 100, 7, 3, 7, 4, 4);}
    static Player Sniper(const std::string& pname = "Player") {return Player(pname, 5, 130, 170, 3, 7, 4, 6, 5);}
    static Player Runner(const std::string& pname = "Player") {return Player(pname, 5, 170, 130, 6, 6, 3, 7, 3);}
    static Player Tank(const std::string& pname = "Player") {return Player(pname, 5, 250, 50, 4, 4, 9, 3, 5);}
    static Player Lucky(const std::string& pname = "Player") {return Player(pname, 5, 180, 120, 5, 5, 4, 4, 7);}
    static Player Base(const std::string& pname = "Player") {return Player(pname, 5, 175, 125, 5, 5, 5, 5, 5);}
};
